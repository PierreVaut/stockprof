...
export const MARKET_OPERATION = 'MARKET_OPERATION';
export const RECEIVE_TIMELINE = 'RECEIVE_TIMELINE';
export const SYNC_UPDATE_TIMELINE_ITEM = 'SYNC_UPDATE_TIMELINE_ITEM';
export const SYNC_FOLLOW_USER = 'SYNC_FOLLOW_USER';
export const SYNC_UNFOLLOW_USER = 'SYNC_UNFOLLOW_USER';
export const SYNC_CREATE_TIMELINE_ITEM = 'SYNC_CREATE_TIMELINE_ITEM';
export const MARK_AS_READ = 'MARK_AS_READ';
export const FLUSH_NOTIFS = 'FLUSH_NOTIFS';
export const RECEIVE_CHAT_ITEM = 'RECEIVE_CHAT_ITEM';
export const RECEIVE_CHAT_HISTORY = 'RECEIVE_CHAT_HISTORY';
export const SYNC_ADD_COMMENT = 'SYNC_ADD_COMMENT';
export const SYNC_SUPPRESS_ACCOUNT = 'SYNC_SUPPRESS_ACCOUNT';
